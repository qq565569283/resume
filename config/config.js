var config = {
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>" +
             "你好，我是黄伟雄，华南师范大学应届毕业生<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>你好！我叫黄伟雄，性别男，，华南师范大学网络工程应届毕业生。我期望的工作岗位是Java后端开发。</p>" +
    ...
    */  
    ...
    work: [
        ...
        ["2021/9 — 2021/12/", "<br>肇庆理工学校",
            "<p><strong>信息技术部</strong></p>" +
            "<p>实习职位：信息技术老师 实习工作内容：任副班主任工作、组织学生参与获得、教授计算机相关课程、负责培训学生考取计算机一级证书、参与Java课程的开发</p>" +
// //             "<p>实习职位：信息技术老师 实习工作内容：任副班主任工作、组织学生参与获得、教授计算机相关课程、负责培训学生考取计算机一级证书、参与Java课程的开发</p>"
//         ],
...
//             "<p>随着阴历7月15中元节的到来，阎王殿的任务愈发庞大，我以及我所在小组主要负责阎王谱后台部分，拟在解决千万访问并发问题，经过不械努力，使得产品稳定、高效的运行。</p>"
     ...
     */
    others: [
        ["2021-11", "华南师范大学国家励志奖学金。"],
        ["2021-12", "华南师范大学优秀师范生实习队队长"],
        ["2021-6-2022-9", "2021级华南师范大学大学兼职班主任，"]
    ],
